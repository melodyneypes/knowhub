                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-4 shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <a href="<?php echo 'http://localhost/uploads/' . rawurlencode($upload['file_path']); ?>" class="btn btn-primary" target="_blank">View Upload</a>
                                           ...
                                           <a href="onlyoffice_editor.php?file=<?php echo urlencode('http://host.docker.internal/uploads/' . $upload['file_path']); ?>&title=<?php echo urlencode($upload['title']); ?>" class="btn btn-success">Edit in ONLYOFFICE</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
